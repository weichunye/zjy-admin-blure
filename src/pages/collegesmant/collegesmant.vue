  ...
  import Left from '@/components/leftcon.vue'
	export default {
      ...
      Header,
        ...
        uploadVisible:false,
        dataList:[
          {type:'2',time: '2014-07-28',name:'《新概念英语》 1-4册 学生用书','desc':'《新概念英语》（New Concept English）作为享誉全球的最为经典地道的英语教材，以其严密的体系性、严谨的科学性、精湛的实用性、浓郁的趣味性深受英语学习者的青睐。', isAccess: false,isUpload:false},
          {type:'2',time: '2012-08-16',name:'《新概念英语语法详解大全》','desc':'本书是专为帮助《新概念英语》的自学者学好语法而编写的。', isAccess: false,isUpload:false},
          {type:'1',time: '2016-04-06',name:'考研背单词及重点阅读总汇','desc':'《考研背单词及重点阅读总汇》通过根认识字，提供了超过6000个丰富的英语单词在测试卷的读字真人发音，《考研背单词及重点阅读总汇》集中整理关键词的阅读理解。', isAccess: true,isUpload:false},
          {type:'1',time: '2014-09-14',name:'《中华经典藏书(套装共50册)》','desc':'《中华经典藏书(套装共50册)》包含：“四书五经”、诸子百家，经典的价值和魅力在流光岁影里永不褪色，先贤圣哲的智慧光芒照耀着我们的现代生活。为在古代经典与现代经验间架起一座沟通的桥梁，中华书局推出“中华经典藏书”丛书。', isAccess: true,isUpload:false},
          {type:'1',time: '2014-09-14',name:'《针灸图谱》-清晰PDF彩图+挂板大图','desc':'本图谱以国家技术监督局颁布的国家标准《经穴部位》为依据，收录经穴361个，经外奇穴48个。在编写形式上采用实体照片定位表现的方法，文字部分中英对照，形象直观，图文并茂，易学易用。', isAccess: false,isUpload:false},
          ...
          {type:'2',time: '2013-09-28',name:'《古方妙用》','desc':'中医是指中国传统医学，是研究人体生理、病理，以及疾病的诊断和防治等的一门学科，它承载着中国古代人民同疾病作斗争的经验和理论知识，', isAccess: true,isUpload:false},
          {type:'2',time: '2014-12-04',name:'《完全自杀手册》','desc':'《完全自杀手册》主要介绍药物、上吊、跳楼、割腕与刎颈、撞车、瓦斯中毒、触电、投水（投河、投海）、自焚、冻死及其他自杀方法如饿死、被动物咬死或以其他物理形式致死方法。', isAccess: false,isUpload:false},
          {type:'2',time: '22016-08-18',name:'《人类之谜》扫描版','desc':'《人类之谜》介绍了人类起源、特异人种、迷离两性、扑朔孪生、奇妙节律、多重人格、五觉通感、记忆绝伦、视力超常、怪异睡眠、离奇梦幻、人体电磁、心灵感应、意念魔力、经络悬谜、气功奥秘、长生不老、死亡再生等内容，本书《人类之谜》的资料翔实、内容丰富，是了解人类起源的一本极佳参考书，值得一读。', isAccess: false,isUpload:false},
          {type:'2',time: '2016-06-15',name:'《高峰实战武功》','desc':'武术，打拳和使用兵器的技术，是中国传统的体育项目，武术又称国术或武艺，中国传统体育项目，其内容是把踢、打、摔、拿、跌、击、劈、刺等动作按照一定规律组成徒手的和器械的各种攻防格斗功夫、套路和单势练习。', isAccess: false,isUpload:false}
        ]
      }
		},
      computed:{
